    ...
    $.fn.betterDropdown = function (options) {
        ...
        function buildDropdown(originalDropdown) {
            ...
            function selectItem($item) {
                ...
                if(label == 'tmulai'){
                    $('input[name="tmulai"]').val($item.children().first().children().last().text());
                    $('input[name="week_mulai"]').val($item.children().first().children().html());

                }else{
                    $('input[name="takhir"]').val($item.children().first().children().last().text());
                    $('input[name="week_akhir"]').val($item.children().first().children().html());
                }
