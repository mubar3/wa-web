          ...
          <!--   <li class="nav-item" role="presentation">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <a class="btn btn-primary" href="javascript:;" data-toggle="modal" data-target="#formPegawai" style="margin-bottom:30px;">
                            Tambah Data
                        </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Kontak</h4>
    ...
    function editPegawai(id){    
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                $('[name=no_hp]').val(data.telpon);                             
            },
        });
    }

    function destroyPegawai(element, id){    
        var link="{{ url('/delete_contact') }}";
        var link2='/'+id;
        var link_all=link+link2;
        // alert(link_all);
        // return;  
